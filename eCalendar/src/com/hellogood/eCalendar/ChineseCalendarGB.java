 ...
 * 中國農曆算法 - 實用於公曆 1901 年至 2100 年之間的 200 年 
 */
...
class ChineseCalendarGB {
	...
	private static String[] animalNames = { "鼠", "牛", "虎", "兔", "龍", "蛇", "馬", "羊", "猴", "雞", "狗", "豬" };
	...
	public int computeChineseFields() {
		...
		// 第二個對應日，用以提高計算效率
		// 公曆 2000 年 1 月 1 日，對應農曆 4697 年 11 月 25 日
	...
	private static char[][] sectionalTermMap = { { 7, 6, 6, 6, 6, 6, 6, 6, 6, 5, 6, 6, 6, 5, 5, 6, 6, 5, 5, 5, 5, 5, 5, 5, 5, 4, 5, 5 },
			...
			{ 7, 8, 8, 8, 7, 7, 8, 8, 7, 7, 7, 8, 7, 7, 7, 7, 6, 7, 7, 7, 6, 6, 7, 7, 6, 6, 6, 7, 7 } };
	private static char[][] sectionalTermYear = { { 13, 49, 85, 117, 149, 185, 201, 250, 250 }, { 13, 45, 81, 117, 149, 185, 201, 250, 250 },
	...
	public String[] getYearTable() {
		...
		table[1] = getTextLine(27, "農曆年曆：" + (chineseYear + 1) + " (" + stemNames[(chineseYear + 1 - 1) % 10]
		...
		table[ln] = blank;
		ln++;
		table[ln] = getTextLine(0, "##/## - 公曆日期/農曆日期，(*)#月 - (閏)農曆月第一天");
		ln++;
		return table;
	}
	...
	private static String[] chineseMonthNames = { "正", "二", "三", "四", "五", "六", "七", "八", "九", "十", "冬", "臘" };
	private static String[] principleTermNames = { "大寒", "雨水", "春分", "穀雨", "夏滿", "夏至", "大暑", "處暑", "秋分", "霜降", "小雪", "冬至" };
	private static String[] sectionalTermNames = { "小寒", "立春", "驚蟄", "清明", "立夏", "芒種", "小暑", "立秋", "白露", "寒露", "立冬", "大雪" };
