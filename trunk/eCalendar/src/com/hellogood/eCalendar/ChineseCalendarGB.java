...
/**
 * ChineseCalendarGB.java Copyright (c) 1997-2002 by Dr. Herong Yang 中國農曆算法 -
 * 實用於公曆 1901 年至 2100 年之間的 200 年
 */
...
class ChineseCalendarGB {
	...
	private static String[] principleTermNames = { "大寒", "雨水", "春分", "谷雨", "夏满", "夏至", "大暑", "处暑", "秋分", "霜降", "小雪", "冬至" };
	...
	private static String[] chineseDayNames = { "初一", "初二", "初三", "初四", "初五", "初六", "初七", "初八", "初九", "初十", "十一", "十二", "十三",
			"十四", "十五", "十六", "十七", "十八", "十九", "二十", "廿一", "廿二", "廿三", "廿四", "廿五", "廿六", "廿七", "廿八", "廿九", "三十", "卅一" };
	...
	public String getYearString() {
		if (chineseYear > 0) {
			return stemNames[(chineseYear - 1) % 10] + branchNames[(chineseYear - 1) % 12] + animalNames[(chineseYear - 1) % 12]
					+ "年";
		}
		return "";
	}
	...
	public String getMonthString() {
		if (chineseMonth >= 0 && chineseMonth < monthNames.length) {
			return monthNames[chineseMonth];
		}
		return "";
	}
	...
	public String getDateString() {
		...
		if (gregorianDate == sectionalTerm) {
			...
			// str = gd + '/' + cd;
			if (chineseDate > 0 && chineseDate < chineseDayNames.length) {
				str = chineseDayNames[chineseDate - 1];
			}
		}
		return str;
	}
	...
	public static void main(String[] arg) {
		...
		System.out.println(c.getYearString());
		System.out.println(c.getMonthString());
